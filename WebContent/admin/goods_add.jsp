...
<%
/*下面是为了拿到select下拉选择条的一级分类内容,后面又用ajax重新写了*/
    ...
    <body>
    		...
    		<div class="main_inner">
    			...
    			<div class="mi_right">
    				<div class="mir_inner">
    					...
    					<div class="miri_form">
							<form action="/shopping/admin/adminAddGoodsInfo.do" method="post" enctype="multipart/form-data">
								<table border="0" cellspacing="0" cellpadding="0" width="100%">
									...
									<tr>
										<th>价格</th>
										<td>
											市场价：&nbsp;&nbsp;<input type="text" name="goods_mprice" class="goods_oriprice" placeholder="例如：18.80" style="width: 160px;"/>
											&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											优惠价：&nbsp;&nbsp;<input type="text" name="goods_rprice" class="goods_curprice" placeholder="例如：16.80" style="width: 160px;"/>
										</td>
									</tr>
									<tr>
										<th>库存</th>
										<td>
											<input type="text" name="goods_stock" class="goods_ttnum" placeholder="例如：888" style="width: 220px;"/>
										</td>
									</tr>
									<tr>
										<th>&nbsp;</th>
		...
		$(function(){
			...
			$.ajax({
				...
				success:function(data){
					...
					for (var i = 0; i < cats.length; i++) {
						...
						//alert(keys[0].key_id);
						_html += "<option value='"+cats[i].cat_id+"'>"+cats[i].cat_name+"</option>";
					}
					$(".goods_categoryfirst").html(_html);
				}
			});
			...
			$("form").submit(function(){
	    		...
	    		if(goods_img01_val == "" || goods_img01_val == undefined) {
	    			layer.msg("商品图片1不能为空！");
	    			return false;
	    		}
	    		if(goods_img02_val == "" || goods_img02_val == undefined) {
	    			layer.msg("商品图片2不能为空！");
	    			return false;
	    		}
	    		if(goods_img03_val == "" || goods_img03_val == undefined) {
	    			layer.msg("商品图片3不能为空！");
	    			return false;
	    		}
	    		if(goods_img04_val == "" || goods_img04_val == undefined) {
	    			layer.msg("商品图片4不能为空！");
	    			return false;
	    		}
	    		if(goods_img05_val == "" || goods_img05_val == undefined) {
	    			layer.msg("商品图片5不能为空！");
	    			return false;
	    		}
